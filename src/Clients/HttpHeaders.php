...
{
    public const X_TIENDANUBE_ACCESS_TOKEN = "X-Linkedstore-Access-Token";
    public const X_TIENDANUBE_HMAC = 'X-Linkedstore-Hmac-Sha256';
    public const X_TIENDANUBE_CLIENT_TELEMETRY = 'X-Linkedstore-Client-Telemetry';
    public const X_TIENDANUBE_API_DEPRECATED_REASON = 'X-Linkedstore-API-Deprecated-Reason';
